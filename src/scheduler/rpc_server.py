...
class RpcServer(object):
    ...
    def on_connection_closed(self, connection, reply_code, reply_text):
        ...
        if self._closing:
            ...
            print('Connection closed, reopening in 1 seconds: (%s) %s',
    ...
    def setup_exchange(self, exchange_name):
        ...
        """
        print("Declaring exchange {}".format(exchange_name))
    ...
    def on_queue_declareok(self, method_frame):
        ...
        """
        print('Binding {} to {} with {}'.format(self.EXCHANGE, self.QUEUE,
                                                self.ROUTING_KEYS))
